...
public class Unit
{
    ...
    // equips unit with weapons according to type
    public void EquipWeapons(IClock clock)
    {
        ...
        {
            case "bomber":
                Weapons.Add(new Weapon(WeaponTypes.bomb.ToString(), 400, TimeSpan.FromSeconds(60), clock.Now));
                break;
            case "cruiser":
                Weapons.Add(new Weapon(WeaponTypes.cannon.ToString(), 10, TimeSpan.FromSeconds(6), clock.Now));
                Weapons.Add(new Weapon(WeaponTypes.cannon.ToString(), 10, TimeSpan.FromSeconds(6), clock.Now));
                Weapons.Add(new Weapon(WeaponTypes.cannon.ToString(), 10, TimeSpan.FromSeconds(6), clock.Now));
                Weapons.Add(new Weapon(WeaponTypes.cannon.ToString(), 10, TimeSpan.FromSeconds(6), clock.Now));
                break;
